...
public class AlgerScript : MonoBehaviour
{
	...
	private void Move()
	{
		...
		FindObjectOfType<SubtitleManager>().Add3DSubtitle("*Step*", slap.length * 2, Color.blue, transform);
	...
	public void GetAngry(float value)
	{
		...
		baldiWait = -3f * baldiAnger / (baldiAnger + 2.5f / baldiSpeedScale) + 3f;//Some formula I don't understand.
	}
